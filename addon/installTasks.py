...
def onInstall():
	requiredVer = "Windows 10 Version 1709"
	...
	if sys.getwindowsversion().build < 16299 and gui.messageBox(_("You are using an older version of Windows. This add-on requires {minSupportedVersion} or later. Are you sure you wish to install this add-on anyway?").format(minSupportedVersion = requiredVer),
