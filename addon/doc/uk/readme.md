...
* Цей додаток не підтримує версії Windows Enterprise LTSC (Long-Term
  ...
  можливе.
* Якщо встановлено Оновлювач додатків 22.08 або пізнішої версії та увімкнено
  фонове оновлення додатків, Windows App Essentials взагалі не
  встановлюватиметься у версіях Windows, які не підтримуються.
* Не всі функції зі збірок Windows Insider Preview підтримуватимуться.
* Деякі функції додатка є або будуть частиною NVDA.
* Для записів, не перелічених нижче, можна припустити, що функції стали
  частиною NVDA, або більше не застосовуються, оскільки додаток не підтримує
  непідтримувані випуски Windows, такі як старі версії Windows 10, або в
  Windows, застосунки та NVDA були внесені зміни, які роблять елементи
  такими, що більше не застосовуються.
