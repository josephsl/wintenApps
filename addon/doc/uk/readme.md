...
* Поліпшено роботу з панеллю завдань у Windows 10 і 11, зокрема оголошення
  ...
  переміщенні по піктограмах панелі завдань (Windows 10 і 11). Зауважте, що
  це імітовані обхідні шляхи для функцій, які були додані, а потім вилучені
  у збірках Insider Preview, і можуть бути вилучені з додатка в майбутньому.
