...
Включены следующие модули приложений или модули поддержки для некоторых
приложений (подробнее смотрите в разделе для каждого приложения):

* Голосовой доступ (Windows 11)
...
* NVDA будет везде объявлять сообщения голосового доступа, такие как
