...
* Подобрена е работата с лентата на задачите в Windows 10 и 11, включително
  ...
  елемента при обхождане на иконите в лентата на задачите (Windows 10 и
  11). Обърнете внимание, че това са емулирани решения за функции, въведени
  и след това премахнати в компилации на Insider Preview и може да бъдат
  премахнати от добавката в бъдеще.
