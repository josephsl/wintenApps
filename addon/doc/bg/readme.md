...
* NVDA ще запише архитектурата на процесора за текущата инсталация на
  ...
  NVDA 2023.1.
* В компилациите на Windows 11 преди Insider Preview компилация 25267, NVDA
  ще докладва резултатите от пренареждането на иконите в лентата на задачите
  при натискане на Alt+Shift+Стрелка наляво/надясно.
* В Windows 11 22H2 диалоговият прозорец "Отваряне с" може да се обхожда
  посредством мишка и/или сензорно взаимодействие.
