...
* Тази добавка изисква Windows 10 версия 1809 (компилация 17763) или по-нова
  и NVDA 2019.3 или по-нова. За най-добри резултати използвайте добавката с
...
* Подсказките в Edge и другите универсални приложения биват разпознавани и
  ще бъдат съобщавани. Това е включено в NVDA 2019.3.
...
* Името и версията на приложението за различни универсални приложения вече
  се докладват правилно. Това е включено в NVDA 2019.3.
...
* Автоматичното дописване на текст ще бъде проследявано и докладвано в
  адресната лента на Edge и други подобни места. Това е включено в NVDA
  2019.3.
* NVDA вече няма да възпроизвежда звука за налични предложения, когато
  натиснете F11, за да превключите на цял екран. Това е включено в NVDA
  2019.3.
* Премахнато е възпроизвеждането на звук при налични предложения за търсене
  в адресната лента. Това е включено в NVDA 2019.3.
...
* Поддръжка за панела за въвеждане на emoji във версия 1709 (есенната
  ...
  във версия 1903 (компилация 18262 и по-нови, включително категориите за
  каомоджи и символи в компилация 18305). Това е приложимо и за версия 2004
  (компилация 18963) и по-нови, тъй като приложението бе
  преименувано. Всички тези промени са вече включени в NVDA 2019.3.
...
* Вече не се възпроизвеждат звукови сигнали от лентите на напредъка за
  индикацията на силата на звука във версия 1803 и по-нови. Това е включено
  в NVDA 2019.3.
