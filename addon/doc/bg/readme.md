...
* NVDA вече няма да съобщава "празен" при натискане на стрелка нагоре или
  надолу при отваряне на изгледа с всички приложения в менюто "Старт". Това
  ще бъде включено в NVDA 2019.3.
...
* Във версия 1909 (актуализацията за ноември 2019 г.) и 20H1 компилация
  18945 и по-нови на Windows 10 се поддържа новия интерфейс за търсене във
  файловия мениджър, задвижван от Cortana.
