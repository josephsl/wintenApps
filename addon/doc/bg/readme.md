...
* NVDA ще запише архитектурата на процесора за текущата инсталация на
  ...
  NVDA 2023.1.
* Подобрена е работата с лентата на задачите на Windows 11, включително
  обявяване на резултатите от пренареждане на иконите при натискане на
