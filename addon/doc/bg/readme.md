...
* Вече ще бъдат докладвани разни промени в състоянието, като например
  \"Помощ за фокусиране\" и \"Яркост\".
...
* Във версиите на Windows 10 след 1709, NVDA ще докладва първата избрана
  ...
  модификатор за избор на тон на кожата при отваряне на категорията
  \"Хора\".
