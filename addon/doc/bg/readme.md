...
* Съвместимост с NVDA: 2020.4 и по-нови версии
...
* Модерна клавиатура (панел с emoji/диктуване/предложения при въвеждане от
  хардуерно устройство/хронология на клипборда/редактори за съвременни
  методи на въвеждане)
* Хора
...
* Тази добавка изисква Windows 10 версия 20H2 (компилация 19042) или
...
* Поддръжката за Windows 11 е експериментална и някои функции няма да
  работят (вижте съответните записи за подробности).
...
* В допълнение към манипулаторите на събития на UIA, предоставени от NVDA,
  ...
  dropped. Когато е указано на NVDA да работи с включено протоколиране за
  ...
  ако известията идват от приложение, различно от текущо фокусираното. Някои
  събития ще предоставят допълнителна информация като брой на елементите в
  контролера за събитие, състояние на елемента за събитие за промяна на
  състоянието и текст на елемент за събитие за състоянието на елемент.
...
* При изтегляне на съдържание като приложения и филми NVDA ще съобщава името
  на продукта и напредъка на изтеглянето (не работи правилно в обновения
  Microsoft Store в Windows 11).
...
по-високо. Също така, NVDA поддържа обновения панел за въвеждане в Windows
11.
