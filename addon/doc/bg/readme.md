...
* NVDA вече няма да възпроизвежда тонове за грешка или да не прави нищо при
  зареждане на тази добавка под Windows 7 и Windows 8.1.
...
* В компилация 18323 и по-нови на Windows 10 NVDA ще докладва промените в
  нивата на якостта и силата на звука.

## Работен център

* Бутонът за бързо действие за яркостта на екрана сега вече се третира като
  бутон, а не като превключвател. Това ще бъде включено в ядрото на NVDA за
  версия2019.1.
* Вече ще бъдат докладвани разни промени в състоянието, като например "Помощ
  за фокусиране" и "Яркост". Това ще бъде включено в ядрото на NVDA за
  версия2019.1.
...
* Стойностите за избор на час в съответните контроли вече се съобщават
  ...
  Windows. Това ще бъде включено в ядрото на NVDA за версия2019.1.
...
* NVDA вече няма да възпроизвежда тонове за грешка или да не прави нищо при
  ...
  Preview. Това ще бъде включено в ядрото на NVDA за версия 2019.1.
* Във версия 1809 (Актуализация за Октомври 2018 г.) и по-нови, NVDA ще
  съобщава резултатите от търсенето за емоджита, ако е възможно. Това ще
  бъде включено в ядрото на NVDA за версия 2019.1.
...
* Определена информация, като например напредъкът на Windows Update, сега
