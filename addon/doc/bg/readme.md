...
* При отваряне, затваряне, пренареждане (компилация 21337 и по-нови) или
  превключване между виртуалните работни плотове, NVDA ще съобщава името на
  текущия работен плот (например "Работен плот 2").
...
по-високо. Също така, NVDA поддържа обновения панел за въвеждане в
компилация 21296 и по-нови.
...
* Добавена поддръжка за обновения панел за въвеждане (комбиниран панел за
  емоджи и хронология на клипборда) в компилация 21296 и по-нови.
