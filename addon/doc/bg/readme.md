...
* Когато подреждате закачени елементи (плочки в Windows 10) в менюто "Старт"
  ...
  време на влачене на елементи, съответно. NVDA да докладва "влачене" е
  включено в NVDA 2022.4.
...
* Промените в състоянието на елементите се докладват в повече приложения,
  включително Visual Studio Community 2022. Това вече е включено в NVDA
  2022.4.
