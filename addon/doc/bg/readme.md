...
* Подобрена е работата с лентата на задачите на Windows 10 и 11, включително
  ...
  Alt+Shift+Стрелка наляво/надясно (Windows 11) и докладване на позицията на
  елемента при обхождане на иконите в лентата на задачите (Windows 10 и 11).
* В приложения като File Explorer и Notepad, където се поддържат прозорци с
  ...
  между тях. Това е внедрено в NVDA 2023.2.
...
* NVDA ще прекъсва речта и ще докладва за обновления на състоянието на
  Windows Update, докато изтеглянето и инсталирането напредва. Това може да
  доведе до прекъсване на говора при навигация в приложението Настройки,
  докато актуализациите се изтеглят и инсталират. Ако използвате Windows 11
  и избирателното регистриране на UIA събития е включено или зададено на
  "Избирателно", трябва да преместите фокуса в списъка с актуализации
  веднага щом се появят, за да може NVDA да докладва напредъка на
  актуализирането.
