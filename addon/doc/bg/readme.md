...
* Поддръжката за Windows 11 е експериментална и някои функции няма да
  работят (вижте съответните записи за подробности). Ще бъде изведен
  предупредителен диалогов прозорец, ако се опитате да инсталирате стабилни
  версии на тази добавка в Windows 11 преди тази версия на операционната
  система да стане общодостъпна.
