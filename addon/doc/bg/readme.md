...
* Поддръжка за панела за въвеждане на emoji във версия 1709 (есенната
  ...
  в 19H1 (компилация 18262). За най-добри резултати при четене на емоджи,
  използвайте речев синтезатор от пакета Windows OneCore.
* Поддръжка за предложения при въвеждане от хардуерна клавиатура във версия
  1803 (актуализацията за април 2018 г.) и по-нови.
* Във версиите на Windows 10 след 1709, NVDA ще докладва първата избрана
  емотикона, когато се отваря панела за емоджи. Това е по-забележимо при
...
* NVDA вече няма да възпроизвежда тонове за грешка или да не прави нищо при
  затваряне на панела за емоджи в по-новите компилации на Insider Preview.
* NVDA ще съобщава резултатите от търсенето за емоджита, ако е възможно.
