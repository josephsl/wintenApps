...
* 此插件需要Windows 10版本1803（版本17134）或更高版本以及NVDA 2018.3或更高版本。为获得最佳体验，请使用最新Windows
  10稳定版（build 17763）和最新稳定版NVDA的插件。
...
* 亮度快速操作现在是一个按钮而不是切换按钮。这将是NVDA 2019.1的一部分。
* 现在将朗读各种状态变化，例如Focus Assist和Brightness。这将是NVDA 2019.1的一部分。

## 时锺和闹钟

* 现在可朗读时间选择器值，当将焦点移动到拾取器控件时会很明显。这也会影响用于选择何时重新启动以完成安装Windows更新的控件。这将是NVDA
  2019.1的一部分。
