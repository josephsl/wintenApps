...
Este complemento es una colección de módulos de aplicación para varias aplicaciones modernas de Windows, así como Mejoras y correcciones para ciertos controles encontrados en Windows 11.
...
Para ver una lista de cambios hechos entre cada actualización del complemento, consulta el documento [Registros de cambios de versiones del complemento (en inglés)][1].
