...
1. Be running the latest supported version of Windows 10 and later (as of March 2025, this means Windows 10 2022 Update (Version 22H2), Windows 11 2024 Update (Version 24H2), and latest Insider Preview (canary/dev/beta/release preview) build).
2. Be running the latest stable version of NVDA or later (as of March 2025, this means NVDA 2024.4.2 or latest alpha release).
...
* Selenium (2025):
	...
	* Selenium 2: March 2025 to August 2025, NVDA 2025.1 and 2025.2 requirements, end of support for Windows 10 series (Version 22H2) and 11 2023 Update (Version 23H2), removed Copilot WebView2 and modern keyboard app modules, removed WinUI 3 app mouse and touch navigation workaround
	* Selenium 3 (final ad-on development milestone): June 2025 to October 2025
