...
1. Be running the latest supported version of Windows 11 (as of July 2025, this means Windows 11 2024 Update (Version 24H2) and latest Insider Preview (canary/dev/beta/release preview) build).
2. Be running the latest stable version of NVDA or later (as of July 2025, this means NVDA 2025.1.2 or latest alpha release).
3. If you wish to offer code/pull requests, you must be running latest stable NVDA (2024.4.2) and Windows 11 (24H2) release or later.
...
For NVDA releases, Windows App Essentials supports latest NVDA releases, including development builds. Unless noted otherwise, the immediate past stable NVDA release is also supported. As of July 2025, Windows App Essentials supports NVDA 2025.1.2 (latest stable) and alpha snapshots.
...
* Selenium (2025):
	...
	* Selenium 3 (final ad-on development milestone): June 2025 to October 2025, NVDA 2025.2 requirement, end of support for Windows 10 series (Version 22H2), brief support for Windows 11 25H2, freezing localization data, add-on contents (most of global plugin content and app modules) removed as NVDA 2025.2 includes them
