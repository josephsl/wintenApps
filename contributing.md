...
* Gallium/Germanium/Arsenic (2024):
	...
	* Arsenic: August 2024 to January 2025, NVDA 2024.3.1 and 2024.4 requirements, initial support for NVDA 2025.1, minimum Windows version detection routine rewrite to emphasize Windows 11, Windows 11 is required to contribute to add-on development, reformatted add-on module contents using Ruff
* Selenium (2025):
