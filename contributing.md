...
1. Be running the latest supported version of Windows 10 and later (as of July 2024, this means Windows 10 2022 Update (Version 22H2), Windows 11 2023 Update (Version 23H2), and latest Insider Preview (canary/dev/beta/release preview) build).
2. Be running the latest stable version of NVDA or later (as of July 2024, this means NVDA 2024.2 or latest alpha release).
...
* Gallium/Germanium/Arsenic (2024):
	...
	* Germanium: May 2024 to September 2024, NVDA 2024.2 requirement, end of support for Windows 11 2022 Update (Version 22H2) and 32-bit Windows 10, restructured install tasks, WinApps global plugin no longer included in add-on installation package (remains in source code repo), Ruff replaces Flake8 as linter, minimal readme with removal of app support notes
	* Arsenic: August 2024 to January 2025, NVDA 2024.3.1 and 2024.4 requirements, removed modern keyboard app module, initial support for NVDA 2025.1
* Selenium (2025):
	* Selenium 1: December 2024 to April 2025, NVDA 2025.1 requirement, minimum Windows version detection routine rewrite to emphasize Windows 11
