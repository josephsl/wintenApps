...
* Removed unmaintained localizations (add-on messages).
...
* Initial support for Windows 11 Version 25H2 (2025 Update).
...
* Modern keyboard: NVDA will no longer announce items in the Windows 11 emoji panel twice.
...
* Voice access: In addition to microphone status changes, messages such as dictation error will be reported from everywhere (NVDA must be installed).
